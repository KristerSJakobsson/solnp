...
class SOLNP_TESTS : public ::testing::Test {
protected:
...
TEST_F(SOLNP_TESTS, ALKYLA_TEST) {
	...
	dccgarch::log_list_ptr logger(new dccgarch::log_list());

	ASSERT_LE(dccgarch::solnp(alkyla_functor(), parameter_data, ib, logger), -172.64179);
