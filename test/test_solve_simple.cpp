...
TEST_CASE("Optimize the Alkyla function simple", "[alkyla]") {


    /* x0, lower, upper */
    dlib::matrix<double, 10, 1> starting_point, lower_bound, upper_bound;
    starting_point =
            17.45,
            12.0,
            110.0,
    ...
    dlib::matrix<double, 3, 1> eq_value;
    eq_value = 0, 0, 0;

    /* Inequality function constraints.*/
    dlib::matrix<double, 4, 1> lb;
    lb = .99, .99, .9, .99;

    dlib::matrix<double, 4, 1> ub;
    ub = 100.0 / 99.0, 100.0 / 99.0, 10.0 / 9.0, 100.0 / 99.0;
