...
double alkyla_objective(const dlib::matrix<double, 10, 1> &m)
/*
Alkyla function from the original documentation of SOLNP:
 ALKYLA: this problem has both equality and inequality constraints, as well as the parameter bounds.
*/
...
dlib::matrix<double, 3, 1> alkyla_equality(const dlib::matrix<double, 10, 1> &m)
/*
Alkyla function from the original documentation of SOLNP:
 ALKYLA: this problem has both equality and inequality constraints, as well as the parameter bounds.
*/
...
dlib::matrix<double, 4, 1> alkyla_inequality(const dlib::matrix<double, 10, 1> &m)
/*
Alkyla function from the original documentation of SOLNP:
 ALKYLA: this problem has both equality and inequality constraints, as well as the parameter bounds.
*/
